...
class _OrderWidgetState extends StateMVC<OrderWidget>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Helper.getPrice(
                            Helper.getTotalProductOrdersPrice(_con.order),
                            context,
                            style: Theme.of(context).textTheme.headline6)
                      ],
                    ),
      ...
      //     : SafeArea(child: Text("${_con.order.productOrders.length}")),
      body: _con.order == null
          ? CircularLoadingWidget(height: 400)
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Column(
                                ...
                                children: <Widget>[
                                  Helper.getPrice(
                                      Helper.getTotalProductOrdersPrice(
                                          _con.order),
                                      context,
                                      style: Theme.of(context)
                                          .textTheme
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text(
                                      _con.order.user.phone.toString(),
                                      overflow: TextOverflow.ellipsis,
                                      style:
                                          Theme.of(context).textTheme.bodyText1,
                                    ),
