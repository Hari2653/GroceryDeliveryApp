...
//        },
  ...
  static double getProductOrderPrice(ProductOrder productOrder) {
    double total = productOrder.price;
    double qty = productOrder.quantity;

    //3433
    // productOrder.extras.forEach((extra) {
    //   total += extra.price != null ? extra.price : 0;
    // });
  ...
  static double getTaxOrder(Order order) {
    double total = 0;
    order.productOrders.forEach((foodOrder) {
      total += getProductOrderPrice(foodOrder);
    });
  ...
  static double getTotalProductOrdersPrice(Order order) {
    double total = 0;
    order.productOrders.forEach((foodOrder) {
      total += getProductOrderPrice(foodOrder);
    });
