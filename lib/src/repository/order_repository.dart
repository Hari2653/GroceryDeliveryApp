...
Future<Stream<Order>> getOrder(orderId) async {
  ...
  final String url =
      ...
      '${GlobalConfiguration().getString('api_base_url')}orders/$orderId?${_apiToken}with=user;driver;productOrders;productOrders.product;productOrders.options;orderStatus;deliveryAddress;payment';
  //.OLD
  // final String url =
